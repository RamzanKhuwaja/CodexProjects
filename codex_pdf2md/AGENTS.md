# codex_pdf2md — Codex Instructions
...
### Task #1 — Convert PDF To Markdown
...
2. Read the source PDF files in `data/current/`.
3. Convert the PDF content to Markdown.
4. Write or update scripts in `scripts/`.
5. Save generated Markdown files to `output/`.
