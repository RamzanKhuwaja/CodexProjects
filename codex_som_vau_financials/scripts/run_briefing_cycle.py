"""
run_briefing_cycle.py - som_vau_financials
==========================================
Prototype runner for the new VAU brief-first workflow.
...
def main():
    print("VAU brief-first prototype")
    verify_source_files()
    ...
    print("Next step for Codex: present 4 short VAU briefs one at a time.")
