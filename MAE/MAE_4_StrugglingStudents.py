...
UPPER_GRADE_MESSAGE = (
    ...
    "Lisa will be reaching out to each teacher individually to discuss student performance, classroom observations, "
...
LOWER_GRADE_MESSAGE = (
    ...
    "Lisa will be in touch with each teacher to discuss student performance and next steps for supporting their development."
)
