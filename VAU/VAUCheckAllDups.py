import VAUCheckClassMap as check1
import VAUDupStudentsInBSViaClassList as check2
import VAUDupStudentsInBSViaAttendance as check3
import VAUDupStudentsInBSViaGrades as check4
